...
Welcome to the **`r params$annee` Tour de l'Abitibi** !

Here's a preview of the Tour de l'Abitibi `r edition`th edition,  which will be held from `r dates_EN %>% filter(code=="Mar") %>% pull(jsem_jour_mois_an)` to `r dates_EN %>% filter(code=="Dim") %>% pull(jsem_jour_mois_an)`.
