--- 
title: "Tour de l'Abitibi Glencore 2023 - Guide Technique"
...
Bienvenue à la **`r edition`^e^** édition du **Tour de l'Abitibi `r params$sponsor` `r params$annee`** qui se tiendra du `r dates_FR %>% filter(code=="Mar") %>% pull(jsem_jour_mois_an) %>% tolower()` au `r dates_FR %>% filter(code=="Dim") %>% pull(jsem_jour_mois_an) %>% tolower()` à `r params$ville`.
