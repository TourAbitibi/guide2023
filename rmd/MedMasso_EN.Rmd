...
<div style="background-color: #ffaca3; border-radius: 5px; border: 2px solid#ff3924; padding: 3px;">Please contact the person in charge of the medical comitee **before** going to the hospital: **`r resp_medical %>% pull(noms)`** at `r resp_medical %>% pull(cell)`</div>
