...
:   The Tour de l’Abitibi `r params$sponsor` is a junior stage road race organized by Le Tour Cycliste de l’Abitibi Inc. (1122, 8e Rue - Suite 201, Val-d'Or (Québec) J9P 3N6) under the rules and regulations of hte <a href="https://uci.org" target="blank">Union Cycliste Internationale</a> (UCI). 
...
:   The race headquarters are at the La Forêt high school, from Sunday `r dates_EN %>% filter(code=="Dim_Av") %>% pull(jour_mois)` to Sunday `r dates_EN %>% filter(code=="Lun_Ap") %>% pull(jour_mois_an)`, located at 850 1re Rue E, Amos, QC J9T 2H8. Opening hours are established in function of the race schedule, but there is a security guard on duty 24 hours a day.
