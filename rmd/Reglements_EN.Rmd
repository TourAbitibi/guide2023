...
:   The race headquarters are at the La Forêt high school, from Sunday `r dates_EN %>% filter(code=="Dim_Av") %>% pull(jour_mois)` to Sunday `r dates_EN %>% filter(code=="Lun_Ap") %>% pull(jour_mois_an)`, located at 850 1^re^ Rue E, Amos, QC J9T 2H8. Opening hours are established in function of the race schedule, but there is a security guard on duty 24 hours a day.
...
:   The winners of the special prizes are chosen by all the technical directors and the commissaires by means of a questionnaire.
