...
- Respect 11:00 PM curfew and noon departure time on Monday, `r dates_EN %>% filter(code=="Lun_Ap") %>% pull(jsem_jour_mois)` unless you have a special agreement with the administration.
