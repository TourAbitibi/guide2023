...
:::{}
The sprints take place on `r params$rue_ligne_arrivee` in `r params$ville`, in front of the `r params$position_ligne_arrivee`. 
:::
:::: 

<aside>
  <a href="https://amos.quebec/" target="_blank" >
  <img src="../img/logo/VilleAmos.png" alt="Logo Ville `r params$ville``" width="100%">
  </a>
</aside>
